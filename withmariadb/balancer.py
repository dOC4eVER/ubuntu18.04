...
rDownloadURL = "https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/sub_xui_dOC4eVER.tar.gz"
...
def configure():
    ...
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx_rtmp")
