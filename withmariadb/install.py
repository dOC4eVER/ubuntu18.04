...
rDownloadURL = {"main": "https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/main_xui_dOC4eVER.tar.gz", "sub": "https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/sub_xui_dOC4eVER.tar.gz"}
...
def installadminpanel():
    rURL = "https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/release_22f.zip"
    ...
    rURL2 = "https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/newstuff.zip"
...
def configure():
    ...
    if rType == "MAIN": 
        ...
        os.system("sed -i 's|https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/balancer.py|https://github.com/emre1393/xtreamui_mirror/raw/master/withmariadb/balancer.py|g'  /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.py")
    ...
    os.system("wget --user-agent=\"Mozilla/5.0\"  -q https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://github.com/dOC4eVER/ubuntu18.04/releases/download/start/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
